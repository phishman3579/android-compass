 ...
 */
public class Matrix {
	private final MixVector worldUp = new MixVector(0, 1, 0);
	private final MixVector dir = new MixVector();
	private final MixVector right = new MixVector();
	private final MixVector up = new MixVector();
